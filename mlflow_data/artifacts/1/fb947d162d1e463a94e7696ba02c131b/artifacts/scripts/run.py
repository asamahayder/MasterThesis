...
mlflow.start_run(
    experiment_id=1, 
    run_name="Adding peak-to-peak as an extra feature", 
    tags={"algorithm": "Random Forest", "domain": "Time Domain"}, 
    description="just to see if this adds any value to the model."
)
...
X, y, ptp, reserved_data, reserved_labels, reserved_ptp = run_step('preprocessing', 'preprocess_data', data, config['preprocessing']['params'])

# Step 3: Feature engineering
X_train, y_train, X_test, y_test = run_step('feature_engineering', 'feature_engineer', (X, y, ptp, reserved_data, reserved_labels, reserved_ptp), config['feature_engineering']['params'])
