...
X_train, y_train = run_step('feature_engineering', 'feature_engineer', (X, y), config['feature_engineering']['params'])

# Step 4: Model training and evaluation
model, metrics = run_step('model_training_and_evaluation', 'train_and_evaluate_model', (X_train, y_train), config['model_training_and_evaluation']['params'])
