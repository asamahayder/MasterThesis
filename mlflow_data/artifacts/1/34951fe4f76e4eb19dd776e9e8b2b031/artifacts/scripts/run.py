...
mlflow.start_run(
    experiment_id=1, 
    run_name="No alignment but with PCA 10 pcs", 
    tags={"algorithm": "Random Forest", "domain": "Time Domain"}, 
    description="last run removed alignment but still kept polyfit which needs the alignment. Now we try with PCA 10 pcs."
)
