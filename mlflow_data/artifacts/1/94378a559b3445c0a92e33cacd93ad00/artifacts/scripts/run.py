...
mlflow.start_run(
    experiment_id=1, 
    run_name="Constraining search close to parameters from best run", 
    tags={"algorithm": "Random Forest", "domain": "Time Domain"}, 
    description="The idea is to see if there are some combination of hyperparemeters that are close to the best hyperparameters from the previous run that can give a better result."
)
