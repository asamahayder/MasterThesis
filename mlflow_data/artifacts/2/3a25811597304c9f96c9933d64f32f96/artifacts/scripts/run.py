...
model, metrics = run_step('model_training_and_evaluation', 'train_and_evaluate_model', (X_train, y_train, X_test, y_test), config['model_training_and_evaluation']['params'])
