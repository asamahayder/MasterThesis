...
def feature_engineer(data, params):
    ...
    polynomial_coefficients = np.hstack((polynomial_coefficients, np.array(shifts).reshape(-1, 1)))
    polynomial_coefficients_reserved = np.hstack((polynomial_coefficients_reserved, np.array(reserved_shifts).reshape(-1, 1)))
